							...
							<ul class="navbar-nav ml-auto main-nav ">
								...
								<?php
									if(isset($_SESSION['username'])){
										...
										{
											echo '<li class="nav-item active"><a class="nav-link" href="../../../TIP-FAL/php/dashboard.php?page=Tableau de bord&action=0">Tableau de bord</a></li>';
										}else
										{
											echo '<li class="nav-item"><a class="nav-link" href="../../../TIP-FAL/php/dashboard.php?page=Tableau de bord&action=0">Tableau de bord</a></li>';
										}
									}
								?>
									<?php 
